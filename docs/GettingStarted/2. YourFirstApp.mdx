...
The HexGrid component exports a simple SVG element with a couple of default props, such as viewbox.  You can substitute your own svg tag with your own props if you'd like more control.  
Under the HexGrid tag, the Layout tag exports an svg group tag, along with providing useful information such as the rotation of the Hexagons.  Finally, we have our Hexagon tag! 
