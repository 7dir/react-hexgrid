...
import { animated, useSprings, useSpring, easings, useSpringRef, useChain } from 'react-spring';
import "./App.css";
...
export default function Hero() {
  ...
  useChain([textSpringRef, spiralSpringRef], [0, 1], 3000);

  return (
    <>
      <div></div>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '95vw', height: '90vh', position: "absolute", zIndex: "2" }}>
        <HexGrid width="150px" height="150px" style={{ background: "transparent" }}>
          <AnimatedHexagon
            radius={41}
            q={0}
            r={0}
        ...
        <animated.div style={{
          ...
          fontSize: "75px", color: "#61dbfb", overflow: "hidden", textWrap: "nowrap"
        }}>react-hexgrid</animated.div>

        <HexGrid width="95vw" height="90h" style={{ position: "absolute", zIndex: "1" }}>
