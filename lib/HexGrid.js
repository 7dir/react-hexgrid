...
export function HexGrid(_a) {
    ...
    return (React.createElement("svg", Object.assign({ className: "grid", width: width, height: height, viewBox: viewBox, version: "1.1", xmlns: "http://www.w3.org/2000/svg" }, props)));
}
