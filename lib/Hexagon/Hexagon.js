...
export function Hexagon(props) {
    ...
    const { q, r, s, fill, cellStyle, style, className, children, onDragStart, onDragEnd, onDrop, onDragOver, onMouseEnter, onMouseLeave, onMouseOver, onClick, data, fillOpacity } = props, rest = __rest(props
    ...
    */
     ...
     */
    , ["q", "r", "s", "fill", "cellStyle", "style", "className", "children", "onDragStart", "onDragEnd", "onDrop", "onDragOver", "onMouseEnter", "onMouseLeave", "onMouseOver", "onClick", "data", "fillOpacity"]);
    // const { layout, points } = useLayoutContext()
    /*
    from ../Layout.tsx
    ...
    */
    ...
    return (React.createElement("g", Object.assign({ className: "hexagon-group", transform: `translate(${pixel.x}, ${pixel.y})` }, rest, draggable, { onDragStart: (e) => {
            if (onDragStart) {
                const targetProps = {
                    hex: hex,
                    pixel,
