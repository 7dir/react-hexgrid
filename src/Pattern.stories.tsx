...
const SvgIcon = (props) => (
    <image
        xlinkHref={'http://192.124.171.94:81/images/favicons/favicon-32x32.png'}
        x={0}
        y={0}
        width={10 * 2}
        height={10 * 2}
...
export const Default: Story = {
    render: () => (
        <>
            ...
            <HexGrid width="100%">
                <Layout>
                    <Pattern id="my-pattern1" link="http://192.124.171.94:81/images/favicons/favicon-16x16.png" />
                    <Hexagon q={0} r={0} s={0} fill="my-pattern1" />
                </Layout>
            </HexGrid>

            <HexGrid width="100%">
                <Layout>
                    <Pattern id="my-pattern2" rc={<SvgIcon />} />
                    <Hexagon q={0} r={0} s={0} fill="my-pattern2" />
                </Layout>
            </HexGrid>
        </>
    )
